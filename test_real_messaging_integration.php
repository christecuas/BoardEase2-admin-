    ...
    <script>
        ...
        async function testConfiguration() {
            ...
            try {
                ...
                const dbResponse = await fetch('get_users_for_messaging.php?current_user_id=1');
        ...
        async function getUsers() {
            ...
            try {
                const response = await fetch(`get_users_for_messaging.php?current_user_id=${userId}`);
        ...
        async function searchUsers() {
            ...
            try {
                const response = await fetch(`search_users.php?current_user_id=${userId}&search_term=${encodeURIComponent(searchTerm)}`);
                const data = await response.json();
        ...
        async function getMessages() {
            ...
            try {
                const response = await fetch(`get_messages.php?user1_id=${senderId}&user2_id=${receiverId}`);
                const data = await response.json();
        ...
        async function getGroupMessages() {
            ...
            try {
                const response = await fetch(`get_group_messages.php?group_id=${groupId}`);
                const data = await response.json();
        ...
        async function getChatList() {
            ...
            try {
                const response = await fetch(`get_chat_list.php?user_id=${userId}`);
                const data = await response.json();
        ...
        async function getUnreadCount() {
            ...
            try {
                const response = await fetch(`get_unread_count.php?user_id=${userId}`);
                const data = await response.json();
